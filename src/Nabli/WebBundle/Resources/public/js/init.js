...
(function($) {
	...
	skel.init({
		prefix: 'bundles/nabliweb/css/',
		reset: 'full',
		breakpoints: {
			'max': { range: '*', href: 'https://ssl-id.de/www.klaudnabli.com/bundles/nabliweb/css/style.css', containers: 1440, viewport: { scalable: false }, grid: { gutters: 40 } },
			'wide': { range: '-1920', href: 'https://ssl-id.de/www.klaudnabli.com/bundles/nabliweb/css/style-wide.css', containers: 1360 },
			'normal': { range: '-1680', href: 'https://ssl-id.de/www.klaudnabli.com/bundles/nabliweb/css/style-normal.css', containers: 1200 },
			'narrow': { range: '-1280', href: 'https://ssl-id.de/www.klaudnabli.com/bundles/nabliweb/css/style-narrow.css', containers: 960 },
			'narrower': { range: '-1000', href: 'https://ssl-id.de/www.klaudnabli.com/bundles/nabliweb/css/style-narrower.css', containers: '95%' },
			'mobile': { range: '-640', href: 'https://ssl-id.de/www.klaudnabli.com/bundles/nabliweb/css/style-mobile.css', grid: { gutters: 20 } },
